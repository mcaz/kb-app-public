...
const notes: NoteView[] = [
  {
    ...
    origin: "agent",
    tags: ["手続き"],
    note_uid: "01ARZ3NDEKTSV4RRFFQ69G5FAV",
    authority: {
      namespace: "procedures",
      role: "canonical",
      status: "active",
      scope: "personal/moving-checklist",
    },
    relations: [],
...
const toHit = (n: NoteView): Hit => ({
  ...
  note_uid: n.note_uid,
  namespace: n.authority?.namespace ?? null,
  authority_role: n.authority?.role ?? null,
  authority_status: n.authority?.status ?? null,
  authority_scope: n.authority?.scope ?? null,
});
